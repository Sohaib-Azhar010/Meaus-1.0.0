...
<div id="international-speakers" class="container-fluid py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
            ...
            <h1 class="display-4 mb-3">International Speakers</h1>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden h-100">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-1.jpg')); ?>" alt="Dr. Anoud Aksam" style="height: 350px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                    ...
                    <div class="p-4">
                        <h4 class="mb-2">Dr. Anoud Aksam</h4>
                        <p class="text-primary fw-bold mb-2"><i class="fa fa-eye-dropper me-2"></i>Cornea and Uveitis</p>
                        <p class="mb-2 small"><strong>Affiliation:</strong> Corneal-uveitis interface expert</p>
                        <p class="mb-0 small"><strong>Focus:</strong> Complex corneal involvement in uveitis</p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Microsoft\Desktop\Frontend Bootstrap\Meaus-1.0.0\resources\views/pages/speakers-events.blade.php ENDPATH**/ ?>