...
<?php $__env->startSection('title', 'About MEAUS - Middle East Africa Uveitis Society'); ?>
<?php $__env->startSection('keywords', 'MEAUS, Middle East Africa Uveitis Society, uveitis, ocular inflammation, ophthalmology, medical society'); ?>
<?php $__env->startSection('description', 'Learn about MEAUS - our history, mission, goals, and founding members. Advancing uveitis care across Middle East and Africa.'); ?>
        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="<?php echo e(asset('img/about.png')); ?>" alt="MEAUS History" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="mb-4">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-1.jpg')); ?>" alt="Prof. Khalid Tabbara" style="height: 300px; object-fit: cover;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-2.jpg')); ?>" alt="Prof. Moncef Khairallah" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/speaker-aldhibi.png')); ?>" alt="Prof. Hassan Al-Dhibi" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="fa fa-user-tie text-white"></i>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-3.jpg')); ?>" alt="Dr. Zamzam Al-Baker" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-1.jpg')); ?>" alt="Dr. Rola Hamam" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/speaker-albloushi.png')); ?>" alt="Dr. Abdulrahman AlBloushi" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-2.jpg')); ?>" alt="Dr. Dina Baddar" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="fa fa-microscope text-white"></i>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-3.jpg')); ?>" alt="Dr. Sana Khochtali" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="fa fa-microscope text-white"></i>
                            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-1.jpg')); ?>" alt="Sheikha Dr. Noura Al Qassimi" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="team-item bg-light rounded overflow-hidden text-center">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="<?php echo e(asset('img/team-2.jpg')); ?>" alt="Dr. Naila Al Harthi" style="height: 300px; object-fit: cover;">
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                <i class="fa fa-bullhorn text-white"></i>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Microsoft\Desktop\Frontend Bootstrap\Meaus-1.0.0\resources\views/pages/about.blade.php ENDPATH**/ ?>