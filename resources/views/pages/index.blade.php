        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div
                    ...
                    <a class="btn btn-lg btn-primary rounded-pill" href="{{ route('service') }}">
        ...
        <div class="owl-carousel price-carousel position-relative" style="padding: 0 45px 45px 45px;">
            <div class="bg-light rounded text-center">
                ...
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('price') }}" class="btn btn-primary rounded-pill py-3 px-5 my-2">Apply Now</a>
                </div>
            </div>
            <div class="bg-light rounded text-center">
                <div class="position-relative">
        ...
        <div class="row g-5">
            <div class="col-xl-4 col-lg-6">
                <div class="bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                        <a class="h3 d-block mb-3" href="{{ route('blog.detail', 1) }}">Dolor clita vero elitr sea stet dolor justo diam</a>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                        <a class="h3 d-block mb-3" href="{{ route('blog.detail', 2) }}">Dolor clita vero elitr sea stet dolor justo diam</a>
                        <p class="m-0">Dolor lorem eos dolor duo et eirmod sea. Dolor sit magna
                            rebum clita rebum dolor stet amet justo</p>
                    </div>
                    <div class="d-flex justify-content-between border-top p-4">
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                        <a class="h3 d-block mb-3" href="{{ route('blog.detail', 3) }}">Dolor clita vero elitr sea stet dolor justo diam</a>
                        <p class="m-0">Dolor lorem eos dolor duo et eirmod sea. Dolor sit magna
                            rebum clita rebum dolor stet amet justo</p>
                    </div>
                    <div class="d-flex justify-content-between border-top p-4">
