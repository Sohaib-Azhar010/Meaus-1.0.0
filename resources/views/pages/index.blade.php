        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="{{ asset('img/about.png') }}"
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                <div class="bg-white text-center rounded p-5">
                    ...
                    <a href="{{ route('contact') }}" class="btn btn-primary w-100 py-3 mt-4">Get in Touch</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <a class="h3 d-block mb-3" href="{{ route('blog.detail', 1) }}">Welcoming Dr. Anoud Al-Saati to Executive Board</a>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <a class="h3 d-block mb-3" href="{{ route('blog.detail', 2) }}">MEAUS Participation at EOS Cairo 2025</a>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="bg-light rounded overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <a class="h3 d-block mb-3" href="{{ route('blog.detail', 3) }}">Upcoming Symposium in Doha 2026</a>
