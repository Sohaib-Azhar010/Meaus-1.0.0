        ...
        <div class="row g-5">
                ...
                <div class="team-item bg-light rounded overflow-hidden h-100">
                    <div class="row g-0">
                        <div class="col-12 col-sm-5">
                            <img class="img-fluid h-100 w-100" src="{{ asset('img/team-1.jpg') }}" alt="Prof. Khalid Tabbara" style="object-fit: cover; min-height: 300px;">
                        </div>
            ...
            <div class="col-lg-6">
                <div class="team-item bg-light rounded overflow-hidden h-100">
                    <div class="row g-0">
                        <div class="col-12 col-sm-5">
                            <img class="img-fluid h-100 w-100" src="{{ asset('img/team-2.jpg') }}" alt="Prof. Moncef Khairallah" style="object-fit: cover; min-height: 300px;">
                        </div>
                        <div class="col-12 col-sm-7">
                            <div class="p-4 h-100 d-flex flex-column">
                                <div class="mb-3">
            ...
            <div class="col-lg-6">
                <div class="team-item bg-light rounded overflow-hidden h-100">
                    <div class="row g-0">
                        <div class="col-12 col-sm-5">
                            <img class="img-fluid h-100 w-100" src="{{ asset('img/speaker-aldhibi.png') }}" alt="Prof. Hassan Al-Dhibi" style="object-fit: cover; min-height: 300px;">
                        </div>
                        <div class="col-12 col-sm-7">
                            <div class="p-4 h-100 d-flex flex-column">
                                <div class="mb-3">
            ...
            <div class="col-lg-6">
                <div class="team-item bg-light rounded overflow-hidden h-100">
                    <div class="row g-0">
                        <div class="col-12 col-sm-5">
                            <img class="img-fluid h-100 w-100" src="{{ asset('img/team-3.jpg') }}" alt="Dr. Zamzam Al-Baker" style="object-fit: cover; min-height: 300px;">
                        </div>
                        <div class="col-12 col-sm-7">
                            <div class="p-4 h-100 d-flex flex-column">
                                <div class="mb-3">
