...
@section('title', 'Media - MEAUS News, Updates & Gallery')
@section('keywords', 'MEAUS news, MEAUS gallery, uveitis events, ophthalmology updates, MEAUS Instagram')
@section('description', 'Stay updated with MEAUS news, events, and browse our photo gallery from international conferences and meetings.')
    ...
    <div class="container">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-1.jpg') }}" alt="New Executive Board Member" style="height: 250px; object-fit: cover;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-2.jpg') }}" alt="Dr. AlBloushi Award" style="height: 250px; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 m-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-3.jpg') }}" alt="IOIS Brazil 2025" style="height: 250px; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 m-3">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('speakers-events') }}#events-participation" class="btn btn-primary rounded-pill">
                            Read More <i class="fa fa-arrow-right ms-2"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-1.jpg') }}" alt="EOS Cairo 2025" style="height: 250px; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 m-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-2.jpg') }}" alt="MIOC Muscat 2024" style="height: 250px; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 m-3">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-3.jpg') }}" alt="First Executive Committee Meeting" style="height: 250px; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 m-3">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('leadership') }}" class="btn btn-primary rounded-pill">
                            Read More <i class="fa fa-arrow-right ms-2"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded overflow-hidden h-100 shadow-sm">
                    <div class="position-relative">
                        <img class="img-fluid w-100" src="{{ asset('img/blog-1.jpg') }}" alt="MEAUS Launch Announcement" style="height: 250px; object-fit: cover;">
                        <div class="position-absolute top-0 start-0 m-3">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('about') }}" class="btn btn-primary rounded-pill">
                            Read More <i class="fa fa-arrow-right ms-2"></i>
                        </a>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row g-4" id="gallery-grid">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="events">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-1.jpg') }}" data-bs-caption="IOIS Brazil 2025 - MEAUS Session">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-1.jpg') }}" alt="IOIS Brazil 2025 - MEAUS Session" style="height: 300px; object-fit: cover;">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="meetings">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-2.jpg') }}" data-bs-caption="First Executive Committee Meeting">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-2.jpg') }}" alt="First Executive Committee Meeting" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="events">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-3.jpg') }}" data-bs-caption="EOS Cairo 2025 Conference">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-3.jpg') }}" alt="EOS Cairo 2025 Conference" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="awards">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-1.jpg') }}" data-bs-caption="Award Ceremony - Dr. AlBloushi">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-1.jpg') }}" alt="Award Ceremony - Dr. AlBloushi" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="events">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-2.jpg') }}" data-bs-caption="MIOC Muscat 2024 Participation">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-2.jpg') }}" alt="MIOC Muscat 2024 Participation" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="meetings">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-3.jpg') }}" data-bs-caption="Planning Session">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-3.jpg') }}" alt="Planning Session" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="education">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-1.jpg') }}" data-bs-caption="Speaker Presentation">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-1.jpg') }}" alt="Speaker Presentation" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="events">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-2.jpg') }}" data-bs-caption="Networking at Conference">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-2.jpg') }}" alt="Networking at Conference" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
            ...
            <div class="col-lg-4 col-md-6 gallery-item" data-category="meetings">
                <div class="position-relative overflow-hidden rounded shadow-sm" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#galleryModal" data-bs-image="{{ asset('img/blog-3.jpg') }}" data-bs-caption="Group Photo - Founding Members">
                    <img class="img-fluid w-100" src="{{ asset('img/blog-3.jpg') }}" alt="Group Photo - Founding Members" style="height: 300px; object-fit: cover;">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-primary bg-opacity-75 opacity-0 transition" style="transition: opacity 0.3s;">
                        <i class="fa fa-search-plus fa-3x text-white"></i>
                    </div>
                    <div class="position-absolute bottom-0 start-0 w-100 p-3 bg-dark bg-opacity-75 text-white">
