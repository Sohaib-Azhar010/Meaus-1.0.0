...
@section('title', 'Contact Us - MEDINOVA')
                ...
                <div class="bg-white rounded p-5 m-5 mb-0">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="text" name="subject" class="form-control bg-light border-0 @error('subject') is-invalid @enderror" placeholder="Subject"
                            ...
                            <div class="col-12">
                                <textarea name="message" class="form-control bg-light border-0 @error('message') is-invalid @enderror" rows="5"
