        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-light mb-2" href="{{ route('service') }}"><i class="fa fa-angle-right me-2"></i>Our Services</a>
                    <a class="text-light mb-2" href="{{ route('team') }}"><i class="fa fa-angle-right me-2"></i>Meet The Team</a>
                    <a class="text-light mb-2" href="{{ route('blog') }}"><i class="fa fa-angle-right me-2"></i>Latest Blog</a>
